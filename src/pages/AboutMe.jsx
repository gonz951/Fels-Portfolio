...
export default function AboutPage() {
    return (
        <div className='card'>
         ...
         <h2>About Me</h2>
         <p className='darker'>
            Paula 'Fel' Gonzalez is a student fresh out of the EdX Web Development Bootcamp. With her brand new skills and willingness to learn, there is nothing holding her back from working immediately. With the bootcamp's help, Fel is adept at working in a group/team setting, even with those she has not worked with before. If there is an overall goal in mind, she will work to achieve it no matter the team. Even outside the bootcamp, Fel has worked in an environment that required team building and proper communication in a working environment.
         </p>
         <p className='darker'>
